...
class ProcessMemoizerTest {
	...
	def testFinishedMemoizer: Unit = {
		...
		val memoizer = new FileProcessMemoizer(NAME, true)
		...
		val mem2 = new FileProcessMemoizer(NAME, false)
	...
	def testMem: Unit = {
		val process = new IterativeRefinementProcess()
		val memoizer = new FileProcessMemoizer("asdf22", true)
		var counter: Int = 0
	...
	def testMemStoreLoad: Unit = {
		...
		val mem2 = new FileProcessMemoizer("asdf22", false)
	...
	def testMemoizerException: Unit = {
		val process = new IterativeRefinementProcess()
		val mem = new FileProcessMemoizer("asdf", true)
