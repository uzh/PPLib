...
object ContestWithSigmaPruning {
	...
	val SELECTION_PROCESS = new ProcessParameter[ProcessStub[List[String], String]]("selectionProcess", WorkflowParam(), Some(List(new SelectBestAlternativeWithFixWorkerCount())))
