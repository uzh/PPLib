...
object GeneticAlgorithmHCompDriver {
	val DEFAULT_RATING_QUESTION: StringQuestionRenderer = new StringQuestionRenderer("Please rate the following paragraph in terms of syntax, its writing style, grammar and possible mistakes", questionAfterTuples = "Please do not accept more than 1 HIT in this group.")
...
class GeneticAlgorithmHCompDriver(val portal: HCompPortalAdapter,
								  ...
								  val combineQuestion: StringQuestionRenderer = GeneticAlgorithmHCompDriver.DEFAULT_COMBINE_QUESTION,
								  val combineTitle: String = GeneticAlgorithmHCompDriver.DEFAULT_COMBINE_TITLE,
								  val mutateQuestion: StringQuestionRenderer = GeneticAlgorithmHCompDriver.DEFAULT_MUTATE_QUESTION,
								  ...
								  val ratingQuestion: StringQuestionRenderer = GeneticAlgorithmHCompDriver.DEFAULT_RATING_QUESTION,
