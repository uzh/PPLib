 ...
 */
@PPLibProcess
class ContestWithMultipleEqualWinnersProcess(params: Map[String, Any] = Map.empty) extends DecideProcess[List[Patch], List[Patch]](params) with HCompPortalAccess {
